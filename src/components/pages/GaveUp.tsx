        ...
        const fetchBooks = async () => {
            ...
            try {
                ...
                const response = await fetch(
                    `http://localhost:8080/api/books/status/gave_up?page=${backendPage}&size=${booksPerPage}&search=${encodeURIComponent(debouncedSearchTerm)}`,
                    {
                        headers: {
                ...
                <Link to="/home_page">
                    <div className="relative group">
                        <FontAwesomeIcon icon={faRightLeft}
                                         className="text-red-800 text-2xl cursor-pointer hover:text-red-900 transition"
                        />
                        <span className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-red-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition duration-200 whitespace-nowrap">
                            Return back
                        </span>
                    </div>
                </Link>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="border-2 border-none p-4 md:p-6 lg:p-8 rounded-lg h-full">
                        <div className="mb-6 md:mb-8">
                            <h1 className="text-3xl md:text-5xl font-bold text-red-800 text-center">
                                Gave up
                            </h1>
                            <h1 className="text-xl md:text-2xl font-bold text-red-600 text-center mt-2">
                                Books: {bookCount}
                            </h1>
                            ...
                            <div className="max-w-md mx-auto mt-4 md:mt-6">
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-red-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-lg"
                                />
                            </div>
                        </div>
                            ...
                            {books.length === 0 ? (
                                <div className="col-span-full text-center py-8">
                                    <p className="text-amber-800 text-lg">
                                        {searchTerm ? `No books found for "${searchTerm}"` : "No books in your 'gave up' category yet."}
                                    </p>
                                </div>
                            ) : (
                                books.map(book => (
                                    <div key={book.id} className="bg-white p-3 md:p-4 rounded-lg shadow-md border-3 border-red-100">
                                        ...
                                        {book.notes && (
                                            <div className="mt-4 pt-4 border-t border-red-400">
                                                <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-4 border-2 border-red-100 shadow-inner">
                                                    <div className="flex items-center gap-3 mb-3">
                                                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-red-600 to-red-200 flex items-center justify-center shadow-sm">
                            ...
                            <div className="flex flex-col items-center gap-4 mt-6 md:mt-8">
                                <div className="flex gap-2 items-center">
                                    <button
                                        ...
                                        className="px-4 py-2 bg-red-800 text-white rounded-lg hover:bg-red-600 transition disabled:opacity-50"
                                    >
                                        Previous
                                    </button>
                                                ...
                                                <button
                                                    ...
                                                    className={`px-3 py-1 rounded-lg ${
                                                        currentPage === pageNumber
                                                            ...
                                                            : 'bg-red-200 text-amber-700 hover:bg-red-300'
                                                    }`}
                                                >
                                                    {pageNumber}
                                                </button>
